...
class TradeEventValuesBuilder( var count: Long = 0,
                               var cumulativeQty: Long = 0, //14
  ...
  def build(): TradeEventValues = new TradeEventValues(count, cumulativeQty, cumulativeValue, lastQty, lastValue, orderQty, orderValue, leavesQty, leavesValue)
}